            ...
            <div className={styles.inputContainer}>
              ...
              <input
                ...
                className={`${styles.input} ${
                  isAvailable === true ? styles.available : isAvailable === false ? styles.unavailable : ""
                }`}
                maxLength={20}
              />
              <div className={styles.status}>
                {isChecking && <span className={styles.checking}>⏳</span>}
                {isAvailable === true && <span className={styles.available}>✅</span>}
                {isAvailable === false && <span className={styles.unavailable}>❌</span>}
              </div>
            </div>
