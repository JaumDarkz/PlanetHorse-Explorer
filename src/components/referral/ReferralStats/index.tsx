    ...
    const animateNumbers = () => {
      ...
      const interval = setInterval(() => {
        ...
        setAnimatedStats({
          ...
          thisMonth: Math.floor(data.thisMonth * progress),
        })
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.statsGrid}>
        ...
        <div className={`${styles.statCard} ${styles.monthly}`}>
          <div className={styles.statIcon}>📅</div>
          <div className={styles.statContent}>
            <div className={styles.statNumber}>{animatedStats.thisMonth}</div>
      ...
      <div className={styles.levelProgress}>
        ...
        <div className={styles.progressBar}>
          <div
            ...
            style={{
              width: `${Math.min((data.totalReferrals % 10) * 10, 100)}%`,
            }}
          ></div>
        </div>
        <div className={styles.progressText}>{data.totalReferrals % 10}/10 referrals to next level</div>
      </div>
    </div>
  )
}
